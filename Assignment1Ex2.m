...
tic
options = optimset('Display', 'off', 'LargeScale', 'off', 'Algorithm', 'active-set');
...
options_grad = optimoptions(@fmincon, 'Display', 'off','Algorithm', 'active-set', ...
...
tic
options_grad = optimoptions(@fmincon, 'Display', 'off', 'Algorithm', 'active-set', 'SpecifyObjectiveGradient',  true, 'SpecifyConstraintGradient', true, 'MaxIterations', 5000, 'MaxFunctionEvaluations', 100000);
